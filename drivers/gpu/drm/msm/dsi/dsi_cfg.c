...
static const char * const dsi_sm6125_bus_clk_names[] = {
	"iface", "bus",
};
...
static const struct msm_dsi_config sm6125_dsi_cfg = {
	.io_offset = DSI_6G_REG_SHIFT,
	.reg_cfg = {
		.num = 1,
		.regs = {
			{"vdda", 21800, 0},	/* 1.232 V */
		},
	},
	.bus_clk_names = dsi_sm6125_bus_clk_names,
	.num_bus_clks = ARRAY_SIZE(dsi_sm6125_bus_clk_names),
	.io_start = { 0x5e94000 },
	.num_dsi = 1,
};
...
static const struct msm_dsi_cfg_handler dsi_cfg_handlers[] = {
	...
	{MSM_DSI_VER_MAJOR_6G, MSM_DSI_6G_VER_MINOR_V2_3_0,
		&sm6125_dsi_cfg, &msm_dsi_6g_v2_host_ops},
