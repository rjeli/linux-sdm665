...
static const unsigned int sm6125_regs_layout[] = {
	[QUSB2PHY_PLL_STATUS] = 0x38,
	[QUSB2PHY_PORT_TUNE1] = 0x80,
	[QUSB2PHY_PORT_TUNE2] = 0x84,
	[QUSB2PHY_PORT_TUNE3] = 0x88,
...
static const struct qusb2_phy_init_tbl sm6125_init_tbl[] = {
	QUSB2_PHY_INIT_CFG_L(QUSB2PHY_PORT_TUNE1, 0xf8),
	QUSB2_PHY_INIT_CFG_L(QUSB2PHY_PORT_TUNE2, 0xe3), /* if panel, a3 */
	QUSB2_PHY_INIT_CFG_L(QUSB2PHY_PORT_TUNE3, 0x81),
	QUSB2_PHY_INIT_CFG_L(QUSB2PHY_PORT_TUNE4, 0xc0), /* if panel, c7 */
	QUSB2_PHY_INIT_CFG(QUSB2PHY_PLL_TUNE, 0x30),
	QUSB2_PHY_INIT_CFG(QUSB2PHY_PLL_USER_CTL1, 0x79),
	QUSB2_PHY_INIT_CFG(QUSB2PHY_PLL_USER_CTL2, 0x21),
	QUSB2_PHY_INIT_CFG_L(QUSB2PHY_PORT_TEST2, 0x14),
...
static const struct qusb2_phy_cfg sm6125_phy_cfg = {
	.tbl = sm6125_init_tbl,
	.tbl_num = ARRAY_SIZE(sm6125_init_tbl),
	.regs = sm6125_regs_layout,
